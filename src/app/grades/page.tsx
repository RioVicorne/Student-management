    ...
    >
      ...
      <main className="ml-64 mt-20 p-8 relative z-10">
        <div className="max-w-[1600px] mx-auto">
          {/* Page Title */}
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-slate-900 drop-shadow-lg">Grade Management</h1>
            <p className="text-slate-700 mt-1 drop-shadow">Manage and monitor all student grades</p>
          </div>
